...
uint64_t __fastcall call_hook(const A ... arguments)
{
	...
	void* control_function = GetProcAddress(LoadLibrary("win32u.dll"), "NtQueryCompositionSurfaceStatistics"); // kert is my dad I lost him a year ago and now he is making a rust cheat with me <3<3<3
